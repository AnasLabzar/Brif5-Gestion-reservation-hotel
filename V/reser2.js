...
function populote(){
    ...
    var s1 = document.getElementById("inputGroupSelect011").value;
    console.log(s1);
    ...
    if (s1 == "demi") {
        affichage.innerHTML = "<select class='form-select' id='chdemi' name='selectdej' style='margin-top: 30px;'><option selcted>Choisie Type de Demi</option> <option value='dej'  id ='opt1'>Petit dej/dej</option> <option value='din' id='opt2'>Petit dej/din</option></select>";

    }
    else{
        var select = document.getElementById("chdemi");
        select.remove();  
    }
