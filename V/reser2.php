    ...
    <div class="interface1">
        ...
        <table style="width:20%">
            <tr>
                ...
                <th><img class="icon-active" src="../fk/step3.png" alt="step3"><div class="linee-active"></div></th>
                <th><img class="icon" src="../fk/step4.png" alt="step4"><div class="linee"></div></th>
            </tr>
        </table>
        <h1 class="tit_t">CHOOSE YOUR Pension</h1>
        ...
        <div class="barr_res">
            <div class="input-group mb-3">
                <select class="form-select" id="inputGroupSelect01" name="selectpen" onchange="populote()">
                    ...
                    <option value="complete" id="op3">Complete</option>
                </select>
